...
ANSWER_GENERATION_SYSTEM_PROMPT = (
    ...
    "5. תתן תשובה ערכית ללקוח שהוא יוכל להבין ממנה את התשובה הסופית, האםמותר או לא מה הסייגים תחת אילו תנאים וכו'"
)
...
ANSWER_GENERATION_PROMPT = (
    ...
    "בסוף התשובה, ציין את המקורות (URL ומספר עמוד) משם קיבלת את המידע."
)
